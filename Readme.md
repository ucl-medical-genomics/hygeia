...
docker tag hygeia/single_group ghcr.io/ucl-medical-genomics/hygeia_single_group:v0.0.2
docker tag hygeia/single_group ghcr.io/ucl-medical-genomics/hygeia_single_group:latest

docker tag hygeia/two_group ghcr.io/ucl-medical-genomics/hygeia_two_group:v0.0.2
...
docker push ghcr.io/ucl-medical-genomics/hygeia_single_group:v0.0.2
docker push ghcr.io/ucl-medical-genomics/hygeia_two_group:latest
docker push ghcr.io/ucl-medical-genomics/hygeia_two_group:v0.0.2
```
