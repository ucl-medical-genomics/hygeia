...
class CaseControlRobustRegimeModel:
  """
  ...
  def observation_fn(self, step, state):
    ...
    control_observation_dist = RobustBetaBinomial(total_count = n_reads_control,
                                            concentration1 = alpha_control,
                                            concentration0 = beta_control,
                                            beta = self._beta)
    case_observation_dist = RobustBetaBinomial(total_count = n_reads_case,
